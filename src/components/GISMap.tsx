    ...
    <div className="relative w-full h-full">
      ...
      >
        <div className="text-white text-center">
          ...
          <p className="text-lg opacity-90">Interactive Map Loading...</p>
          <p className="text-sm mt-4 opacity-75">Click anywhere to test location selection</p>
        </div>
      </div>
      
      <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm p-3 rounded-lg shadow-md z-[1000]">
        <h4 className="font-semibold text-sm mb-2 text-foreground">Status</h4>
